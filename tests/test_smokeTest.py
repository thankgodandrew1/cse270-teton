...
class TestSmokeTest():
  ...
  def test_adminPage(self):
    ...
    self.driver.set_window_size(1271, 728)
  ...
  def test_joinPage(self):
    ...
    self.driver.find_element(By.NAME, "lname").send_keys("Tester1")
    self.driver.find_element(By.NAME, "bizname").send_keys("Tester Business")
